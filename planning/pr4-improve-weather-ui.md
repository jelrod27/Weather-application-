...
4. **One set of travel controls.** Use one Fly/Drive choice and one day choice for the form, result and national outlook. Clear results when inputs change and ignore stale responses after edits. Preserve existing corridor/airport limits and errors, and do not imply departure optimization.
