...
export const cityData: { [key: string]: { 
  ...
  'washington-dc': {
    ...
    title: 'Washington DC Weather Forecast - 16 Bit Weather',
    description: 'Current weather conditions and 5-day forecast for Washington, DC. Real-time weather data with humidity, thunderstorm, and winter storm tracking.',
    content: {
      intro: 'Washington, D.C. has a humid subtropical climate with hot, humid summers and cool winters. The city sits in the Potomac River valley between the Blue Ridge and the Chesapeake Bay, which keeps it warmer and wetter than the interior of Maryland and Virginia.',
      climate: 'July averages a high near 90°F with overnight lows above 70°F, while January averages a 44°F high and a 29°F low. The city receives about 40 inches of precipitation a year and roughly 13 inches of snow.',
      patterns: 'Summer afternoons bring frequent thunderstorms and heat index values above 100°F. Winter storms can arrive as snow, sleet, or cold rain depending on a few degrees of temperature, because the city sits close to the typical rain/snow line. Nor\'easters and the remnants of tropical systems both reach the region.',
    },
  },
  'las-vegas-nv': {
    name: 'Las Vegas',
  ...
  'buffalo-ny': {
    name: 'Buffalo',
    state: 'NY',
    searchTerm: 'Buffalo, NY',
    title: 'Buffalo Weather Forecast - 16 Bit Weather',
    description: 'Current weather conditions and 5-day forecast for Buffalo, NY. Real-time Western New York weather with lake-effect snow tracking.',
    content: {
      intro: 'Buffalo has a humid continental climate shaped by Lake Erie. The lake holds the city back in spring, keeps summers comfortable, and fuels the lake-effect snow bands that give Buffalo its reputation.',
      climate: 'July averages a high of 81°F with moderate humidity, while January averages a 32°F high and a 19°F low. Annual precipitation is about 40 inches, and annual snowfall is roughly 95 inches — among the highest of any large US city.',
      patterns: 'Lake-effect snow peaks from late November through January, when cold air crossing relatively warm Lake Erie stacks narrow bands over the region that can drop several feet in a day. Once the shallow lake freezes over, snowfall drops off sharply.',
    },
  },
  'indianapolis-in': {
    name: 'Indianapolis',
  ...
  'chandler-az': {
    ...
    title: 'Chandler Weather Forecast - 16 Bit Weather',
    description: 'Current weather conditions and 5-day forecast for Chandler, AZ. Real-time East Valley desert weather with extreme heat and monsoon tracking.',
    content: {
      intro: 'Chandler has a hot desert climate in the southeast corner of the Phoenix metro area. Sonoran Desert sunshine, very low humidity, and extreme summer heat define the year.',
      climate: 'Average highs stay at or above 100°F from June through September and peak near 106°F in July. Winters are mild, with January averaging a 67°F high and a low near 42°F. Annual rainfall is only about 8 inches.',
      patterns: 'The North American Monsoon brings thunderstorms, dust storms, and flash flooding from July through September. The rest of the year is dominated by dry, sunny high pressure, and the less-developed East Valley cools off more at night than central Phoenix.',
    },
  }
}
...
export const cityEnrichments: Record<string, CitySeoEnrichment> = {
  ...
  'los-angeles-ca': {
    ...
    uniqueFacts: [
      ...
      'Average highs span just 16°F across the whole year — 68°F in December and January against 84°F in August.',
    ],
    faqs: [
      { question: 'What is the climate in Los Angeles, California?', answer: 'Los Angeles has a Mediterranean climate (Köppen Csb): warm dry summers, mild wet winters, and about 15 inches of rain a year that falls almost entirely between November and March. August averages a high of 84°F and January a high of 68°F.' },
      { question: 'What is Los Angeles weather like year round?', answer: 'The annual range is unusually narrow. Average highs run 68°F in December and January, the low 70s°F through spring, and peak at 83-84°F in July, August and September. Lows range from the upper 40s°F in winter to the mid-60s°F in late summer, and the dry season lasts from May through October.' },
      { question: 'How cold does Los Angeles get?', answer: 'December and January are the coolest months, averaging a 68°F high and a 48-49°F low. Freezing temperatures are effectively unheard of near downtown, though inland valleys and canyons can drop into the 30s°F on clear winter nights.' },
  ...
  'chicago-il': {
    ...
    uniqueFacts: [
      ...
      'Chicago\'s average high swings 53°F across the year — 32°F in January against 85°F in July.',
    ],
    faqs: [
      { question: 'What is the climate in Chicago, Illinois?', answer: 'Chicago has a humid continental climate (Köppen Dfa): cold snowy winters, hot humid summers, and about 38 inches of precipitation a year including roughly 37 inches of snow. January averages a 32°F high and an 18°F low; July averages 85°F and 68°F.' },
      { question: 'What is Chicago weather like year round?', answer: 'Winter runs cold and windy with January highs at freezing and lows near 18°F. Spring is late and erratic — snow in April is possible alongside 80°F days. June through August average highs of 80-85°F with high humidity, and September and October are mild and settled before winter returns.' },
      { question: 'What is Chicago weather like by month?', answer: 'Average highs climb from 32°F in January to 47°F in March, 70°F in May and 85°F in July, then fall back through 63°F in October to 36°F in December. Only June, July and August average highs of 80°F or better.' },
  ...
  'seattle-wa': {
    ...
    uniqueFacts: [
      ...
      'Average highs range only from 47°F in December to 77°F in July and August — a narrow 30°F swing for a city this far north.',
    ],
    faqs: [
      { question: 'What is the climate in Seattle, Washington?', answer: 'Seattle has an oceanic, marine west coast climate (Köppen Cfb): mild wet winters, warm dry summers, and about 37 inches of precipitation a year. July and August average highs of 77°F, while December averages a 47°F high and a 36°F low.' },
      { question: 'What is Seattle weather like year round?', answer: 'Rain runs from October through May, with winter highs in the upper 40s°F and lows in the mid-to-upper 30s°F. Spring warms slowly through the 50s and 60s°F. July and August are warm, dry and sunny at 77°F, and September stays pleasant before the Pacific storm track returns in October.' },
      { question: 'What is Seattle weather like by month?', answer: 'Average highs run 48°F in January, 54°F in March, 66°F in May, 77°F in July and August, 60°F in October and 47°F in December. Every month from November through March averages a high below 55°F, and lows never average below 36°F.' },
  ...
  'houston-tx': {
    ...
    uniqueFacts: [
      ...
      'Average lows stay at or above 71°F from June through September, so summer nights bring almost no relief from the heat.',
    ],
    faqs: [
      { question: 'What is the climate in Houston, Texas?', answer: 'Houston has a humid subtropical climate (Köppen Cfa): hot, humid summers, mild winters, and about 50 inches of rain a year. July and August average highs of 94°F with lows near 75°F, while January averages a 62°F high and a 43°F low.' },
      { question: 'What is Houston weather like year round?', answer: 'Humidity is high in every season. January is the coolest month at a 62°F high and a 43°F low, spring warms rapidly into the 80s°F by April, and June through September average highs of 90-94°F with overnight lows above 70°F. Rain falls year-round rather than in a single wet season.' },
      { question: 'How cold does Houston get?', answer: 'January is the coldest month, averaging a 62°F high and a 43°F low. Hard freezes happen once or twice in a typical winter when Arctic air pushes deep into Texas, but extended cold is unusual and highs recover within a day or two.' },
  ...
  'phoenix-az': {
    ...
    uniqueFacts: [
      ...
      'Average highs stay at or above 100°F for four straight months, June through September.',
    ],
    faqs: [
      { question: 'What is the climate in Phoenix, Arizona?', answer: 'Phoenix has a hot desert climate (Köppen BWh): extreme summer heat, mild sunny winters, very low humidity, and only about 8 inches of rain a year. July averages a high of 106°F, while December and January average highs of 66-67°F.' },
      { question: 'What is Phoenix weather like year round?', answer: 'Average highs stay at or above 100°F from June through September and peak at 106°F in July, with overnight lows in the low 80s°F. October through April is the mild half of the year — January averages a 67°F high and a 46°F low. Rain is scarce in every month.' },
      { question: 'What is Phoenix weather like by month?', answer: 'Average highs run 67°F in January, 78°F in March, 95°F in May, 106°F in July, 89°F in October and 66°F in December. Lows follow the same curve, from the mid-40s°F in midwinter to the low 80s°F in July and August.' },
  ...
  'philadelphia-pa': {
    ...
    uniqueFacts: [
      ...
      'The spread between Philadelphia\'s coldest and warmest average monthly high is 47°F — 40°F in January against 87°F in July.',
    ],
    faqs: [
      { question: 'What is the climate in Philadelphia, Pennsylvania?', answer: 'Philadelphia has a humid subtropical climate (Köppen Cfa) with four distinct seasons: hot humid summers, cold winters, and about 42 inches of precipitation spread fairly evenly through the year. July averages a 87°F high, January a 40°F high.' },
      { question: 'What is Philadelphia weather like year round?', answer: 'January is the coldest month at a 40°F high and a 25°F low. Spring warms quickly from the 50s°F in March to the 70s°F in May. July and August average highs of 85-87°F with humid nights near 69°F, and October settles into the upper 60s°F with the year\'s most comfortable conditions.' },
      { question: 'How cold does Philadelphia get in winter?', answer: 'January is the coldest month, averaging a 40°F high and a 25°F low. Nights below freezing are routine from December through February, but readings below zero are rare — the city sits far enough south and close enough to the coast to blunt Arctic outbreaks.' },
  ...
  'san-diego-ca': {
    ...
    uniqueFacts: [
      ...
      'December through March each average a high of exactly 66°F — four consecutive months with no measurable change in daytime warmth.',
    ],
    faqs: [
      { question: 'What is the climate in San Diego, California?', answer: 'San Diego has a semi-arid Mediterranean climate (Köppen BSk/Csb): mild temperatures year-round, low humidity, and only about 10 inches of rain a year, nearly all of it between November and April. Average highs range from 66°F in winter to 78°F in August.' },
      { question: 'What is San Diego weather like year round?', answer: 'The seasons are unusually muted. December through March each average a 66°F high with lows around 50-54°F. Highs rise slowly through spring, peak at 77-78°F in August and September, and ease back through the fall. Summer is effectively rainless; the marine layer clouds mornings in May and June.' },
      { question: 'How cold does San Diego get?', answer: 'December through March are the coolest months, averaging a 66°F high and lows around 50-54°F. Frost is essentially unknown near the coast, and the coldest reading downtown in more than 150 years of records is 25°F.' },
  ...
  'austin-tx': {
    ...
    uniqueFacts: [
      ...
      'January is Austin\'s coldest month, averaging a 61°F high and a 40°F low — mild enough that hard freezes are the exception rather than the rule.',
    ],
    faqs: [
      { question: 'What is the climate in Austin, Texas?', answer: 'Austin has a humid subtropical climate (Köppen Cfa): long hot summers, short mild winters, and about 34 inches of rain a year concentrated in spring and fall. July and August average highs of 96-97°F, while January averages a 61°F high and a 40°F low.' },
      { question: 'What is Austin weather like year round?', answer: 'Winter is brief and mild, with January highs near 61°F and lows around 40°F. Spring warms through the 70s and 80s°F and brings the wettest stretch of the year. June through September average highs of 92-97°F, and October finally drops back into the low 80s°F.' },
      { question: 'How cold does Austin get in winter?', answer: 'January is the coldest month, averaging a 61°F high and a 40°F low. Freezing nights happen a handful of times each winter, but daytime highs almost always climb back above freezing. The February 2021 hard freeze was a rare and severe exception.' },
  ...
  'san-francisco-ca': {
    ...
    uniqueFacts: [
      ...
      'September, not July, is San Francisco\'s warmest month, averaging a 72°F high against July\'s 68°F.',
    ],
    faqs: [
      { question: 'What is the climate in San Francisco, California?', answer: 'San Francisco has a Mediterranean, cool-summer climate (Köppen Csb): mild wet winters, cool foggy summers, and about 23 inches of rain a year falling almost entirely between November and April. Average highs range only from 58°F in December to 72°F in September.' },
      { question: 'What is San Francisco weather like year round?', answer: 'The annual range is the narrowest of any major US city. Average highs sit at 58°F in December and January, drift into the mid-60s°F through spring, hold near 68°F through the foggy summer, and peak at 72°F in September. Lows never average below 46°F or above 56°F.' },
      { question: 'How cold does San Francisco get?', answer: 'December and January are the coolest months, averaging a 58°F high and a 46°F low. Freezing temperatures are rare downtown — the coldest reading on record is 27°F — because the surrounding ocean keeps winter nights mild.' },
  ...
  'washington-dc': {
    climateType: 'Humid subtropical (Köppen Cfa)',
    seasons: {
      spring: 'Spring is the region\'s signature season — Tidal Basin cherry blossoms usually peak in late March or early April, and highs climb from the mid-50s°F in March to the upper 70s°F by May. Rain and thunderstorms increase as the season goes on.',
      summer: 'Summers are hot and humid. July and August average highs of 88-90°F with overnight lows near 70°F, afternoon thunderstorms are frequent, and heat index values regularly pass 100°F.',
      fall: 'Fall is the most settled season. September stays warm, October brings mild days near 70°F with the year\'s lowest humidity, and foliage peaks in the surrounding Blue Ridge in mid-to-late October.',
      winter: 'Winters are cool rather than severe — January averages a 44°F high and a 29°F low. Snow averages about 13 inches a year, but the city sits close enough to the rain/snow line that many storms arrive as sleet or cold rain instead.',
    },
    monthlyHighs: [44, 48, 56, 68, 77, 86, 90, 88, 81, 70, 59, 48],
    monthlyLows: [29, 31, 37, 47, 57, 67, 72, 70, 63, 51, 41, 33],
    bestTimeToVisit: 'Late September through October, or early April through mid-May. Both windows deliver highs in the 60s-70s°F, low humidity, and minimal storm risk. April adds the cherry blossoms; October adds foliage and the driest stretch of the year.',
    severeRisks: ['Heat waves', 'Severe thunderstorms', 'Nor\'easters', 'Hurricane remnants', 'Ice storms'],
    uniqueFacts: [
      'Washington sits near the average rain/snow line for East Coast winter storms, so one system can bury the northwest suburbs while downtown gets cold rain.',
      'July and August both average overnight lows at or above 70°F, which is why the humidity feels relentless well after dark.',
      'Tidal Basin cherry blossom peak bloom tracks late-winter temperatures closely and has ranged from mid-March to mid-April.',
      'The remnants of tropical systems — Agnes in 1972, Isabel in 2003 — have caused more flooding damage in the District than any direct hurricane landfall.',
      'The Potomac valley funnels humid air inland from the Chesapeake, keeping the city muggier than the Piedmont just to the west.',
    ],
    faqs: [
      { question: 'What is the climate in Washington, DC?', answer: 'Washington has a humid subtropical climate (Köppen Cfa): hot humid summers, cool winters, and about 40 inches of precipitation a year. July averages a 90°F high and a 72°F low, while January averages a 44°F high and a 29°F low.' },
      { question: 'What is Washington DC weather like year round?', answer: 'January is the coldest month at a 44°F high and a 29°F low. Spring warms quickly through the 60s and 70s°F, July and August average highs of 88-90°F with humid nights near 70°F, and October settles near 70°F with the year\'s most comfortable conditions.' },
      { question: 'How cold does Washington DC get in winter?', answer: 'January is the coldest month, averaging a 44°F high and a 29°F low. Nights below freezing are routine from December through February, but sustained subzero cold is rare because the city sits south of the main Arctic air corridor and close to the Chesapeake.' },
      { question: 'How much snow does Washington DC get?', answer: 'About 13 inches in an average winter, with extreme year-to-year variability. The city sits near the typical rain/snow line for coastal storms, so some winters barely register while the 2009-10 season buried the area under more than 50 inches.' },
      { question: 'Is Washington DC humid in summer?', answer: 'Yes. July and August average overnight lows at or above 70°F, and afternoon dewpoints in the low 70s°F push heat index values past 100°F several times each summer. Thunderstorms are frequent but only briefly break the humidity.' },
      { question: 'Does Washington DC get hurricanes?', answer: 'Direct hits are rare because the city is well inland from the Atlantic, but the remnants of tropical systems regularly bring heavy rain, wind, and flooding along the Potomac and Anacostia. Agnes (1972) and Isabel (2003) are the benchmark events.' },
      { question: 'What is Washington DC weather like by month?', answer: 'Average highs run 44°F in January, 56°F in March, 77°F in May, 90°F in July, 70°F in October and 48°F in December. Lows follow the same curve, from about 29°F in midwinter to 72°F in midsummer.' },
      { question: 'When is the best time to visit Washington DC?', answer: 'Late September through October, or early April through mid-May. Both deliver highs in the 60s-70s°F, low humidity, and minimal storm risk. Cherry blossom peak bloom usually falls in the last week of March or the first week of April.' },
    ],
  },
  'las-vegas-nv': {
    climateType: 'Hot desert (Köppen BWh)',
  ...
  'portland-or': {
    ...
    uniqueFacts: [
      ...
      'December is Portland\'s coolest month, averaging a 46°F high and a 35°F low — far milder than most US cities at the same latitude.',
    ],
    faqs: [
      { question: 'What is the climate in Portland, Oregon?', answer: 'Portland has an oceanic, marine west coast climate (Köppen Cfb): mild wet winters, warm dry summers, and about 43 inches of precipitation a year. July and August average highs of 82°F, while December averages a 46°F high and a 35°F low.' },
      { question: 'What is Portland weather like year round?', answer: 'Rain runs from October through May, with December and January highs in the mid-to-upper 40s°F and lows in the mid-30s°F. Spring warms slowly through the 50s and 60s°F, and July and August are warm, dry and sunny with highs around 82°F. September stays pleasant before the rain returns.' },
      { question: 'How cold does Portland get?', answer: 'December is the coldest month, averaging a 46°F high and a 35°F low. Freezing nights happen through the winter, but sustained deep cold is rare because Pacific air keeps the valley moderated.' },
  ...
  'orlando-fl': {
    ...
    uniqueFacts: [
      ...
      'Orlando\'s monthly average high never drops below 72°F — even January afternoons are warm by national standards.',
    ],
    faqs: [
      { question: 'What is the climate in Orlando, Florida?', answer: 'Orlando has a humid subtropical climate (Köppen Cfa): hot, wet, stormy summers and warm, dry winters. June through September average highs of 90-92°F, January averages a 72°F high and a 50°F low, and the city receives roughly 51 inches of rain a year.' },
      { question: 'What is Orlando weather like year round?', answer: 'No month averages a high below 72°F. Winter is dry and mild with highs in the low-to-mid 70s°F and lows in the low 50s°F. Highs reach the mid-80s°F by April and the low 90s°F from June through September, when near-daily afternoon thunderstorms arrive.' },
      { question: 'Does it rain a lot in Orlando?', answer: 'Yes — about 51 inches a year, but it is heavily seasonal. More than half of that total falls between June and September in short, intense afternoon thunderstorms. Winter and early spring are comparatively dry.' },
  ...
  'cleveland-oh': {
    ...
    uniqueFacts: [
      ...
      'At 82°F, Cleveland\'s average July high is the coolest among Ohio\'s largest cities, thanks to Lake Erie breezes.',
    ],
    faqs: [
      { question: 'What is the climate in Cleveland, Ohio?', answer: 'Cleveland has a humid continental climate (Köppen Dfa) heavily modified by Lake Erie: cold, cloudy, snowy winters and warm summers moderated by lake breezes. January averages a 33°F high and a 20°F low, July an 82°F high, and the city receives about 68 inches of snow a year.' },
      { question: 'What is Cleveland weather like year round?', answer: 'Winter is the defining season — highs in the 30s°F from December through February with heavy lake-effect snow. Spring is cool and late because the lake stays cold into June. July and August average highs of 81-82°F, and September and October are mild and sunny before the snow machine restarts.' },
      { question: 'How much snow does Cleveland get?', answer: 'About 68 inches in an average winter, among the highest totals of any large US city. Most of it falls in lake-effect bands between late November and January, and the east-side snowbelt suburbs routinely collect far more than downtown.' },
  ...
  'buffalo-ny': {
    climateType: 'Humid continental (Köppen Dfa/Dfb)',
    seasons: {
      spring: 'Spring is cool and late. Lake Erie stays cold into June and holds the shoreline back while inland Western New York warms. March still sees snow, April is raw and damp, and May finally reaches the upper 60s°F.',
      summer: 'Summers are warm and comfortable with highs around 80°F and modest humidity by Eastern standards. This is Buffalo\'s sunniest, driest stretch, and the lake breeze keeps the waterfront pleasant on hot afternoons.',
      fall: 'September and October are mild and settled, with highs in the 60s-70s°F. The lake is still warm relative to the first Arctic air of the season, which makes late November and December the peak of lake-effect snow season.',
      winter: 'Winters are cold, cloudy, and snowy. January averages a 32°F high and a 19°F low, and the city collects about 95 inches of snow between lake-effect bands and passing storm systems.',
    },
    monthlyHighs: [32, 34, 43, 55, 67, 76, 81, 79, 72, 60, 48, 37],
    monthlyLows: [19, 19, 26, 37, 47, 57, 62, 61, 54, 44, 34, 26],
    bestTimeToVisit: 'Late June through September. Summer delivers highs around 80°F, low humidity, long days, and the driest weather of the year. September is especially good — warm afternoons, cool nights, and early fall color without the crowds.',
    severeRisks: ['Lake-effect snow', 'Blizzards', 'Extreme cold', 'Windstorms', 'Severe thunderstorms'],
    uniqueFacts: [
      'Buffalo averages about 95 inches of snow a year, one of the highest totals of any large US city.',
      'Lake-effect bands are narrow: a single storm can bury the southern suburbs under three feet while the airport a few miles north records an inch.',
      'Lake Erie is shallow and freezes over in most winters, which usually shuts the lake-effect machine down by late January or February.',
      'Buffalo\'s average July high of 81°F is warmer than Seattle\'s or San Francisco\'s — a fact that surprises people who only know the city\'s winters.',
      'The lake works in both directions: it holds spring back along the shoreline and then keeps September and October milder than inland Western New York.',
    ],
    faqs: [
      { question: 'What is the climate in Buffalo, New York?', answer: 'Buffalo has a humid continental climate: cold snowy winters and warm, relatively dry summers, heavily modified by Lake Erie. January averages a 32°F high and a 19°F low, July averages 81°F, and the city receives about 40 inches of precipitation and 95 inches of snow a year.' },
      { question: 'What is Buffalo weather like year round?', answer: 'Winter is long and snowy, with highs in the 30s°F from December through February. Spring is cool and late because Lake Erie stays cold into June. July and August average highs of 79-81°F with comfortable humidity, and September and October are mild before lake-effect season starts again.' },
      { question: 'How cold does Buffalo get in winter?', answer: 'January and February average highs of 32-34°F with lows near 19°F. Arctic outbreaks push temperatures below zero a few times in most winters, and wind coming off the lake makes it feel considerably colder than the thermometer reads.' },
      { question: 'How much snow does Buffalo get?', answer: 'About 95 inches in an average winter. Most of it comes from lake-effect bands off Lake Erie between late November and January, and individual events have dropped more than five feet on the southern suburbs while the north side stayed nearly clear.' },
      { question: 'Why does Buffalo get so much lake-effect snow?', answer: 'Cold air crossing the relatively warm water of Lake Erie picks up heat and moisture, then releases it as intense, narrow snow bands when it reaches land. Buffalo sits at the downwind end of the lake\'s long axis, which gives those bands the maximum possible fetch.' },
      { question: 'Does it rain a lot in Buffalo?', answer: 'Rainfall itself is moderate — about 40 inches of total precipitation a year, comparable to New York City. What sets Buffalo apart is how often the sky is overcast, especially from November through March.' },
      { question: 'What is Buffalo weather like by month?', answer: 'Average highs run 32°F in January, 43°F in March, 67°F in May, 81°F in July, 60°F in October and 37°F in December. Lows range from about 19°F in midwinter to 62°F in July.' },
      { question: 'When is the best time to visit Buffalo?', answer: 'Late June through September. Summer highs sit around 80°F with low humidity, long daylight, and the year\'s driest weather. September adds cool nights and early fall color in the surrounding Niagara region.' },
    ],
  },
  'indianapolis-in': {
    climateType: 'Humid continental (Köppen Dfa)',
  ...
  'columbus-oh': {
    ...
    uniqueFacts: [
      ...
      'January averages a 37°F high and a 21°F low in Columbus, a few degrees milder than Cleveland\'s lakeside winters.',
    ],
    faqs: [
      { question: 'What is the climate in Columbus, Ohio?', answer: 'Columbus has a humid continental climate (Köppen Dfa) with four distinct seasons: warm humid summers, cold cloudy winters, and about 40 inches of precipitation a year including roughly 22 inches of snow. July averages an 85°F high, January a 37°F high.' },
      { question: 'What is Columbus weather like year round?', answer: 'January is the coldest month at a 37°F high and a 21°F low. Spring warms from the low 50s°F in March to the low 70s°F in May with frequent rain. June through August average highs of 82-85°F with humid afternoons, and September and October are the driest, sunniest stretch of the year.' },
      { question: 'How much snow does Columbus get?', answer: 'About 22 inches in an average winter, well below the lake-effect totals in northern Ohio. Freezing rain and ice storms tend to cause more disruption in central Ohio than snow does.' },
  ...
  'raleigh-nc': {
    ...
    uniqueFacts: [
      ...
      'Raleigh\'s average January high of 51°F stays well above freezing, so winter cold usually arrives overnight and breaks by afternoon.',
    ],
    faqs: [
      { question: 'What is the climate in Raleigh, North Carolina?', answer: 'Raleigh has a humid subtropical climate (Köppen Cfa): hot humid summers, mild winters, and about 46 inches of precipitation a year spread across all seasons. July averages an 89°F high and a 69°F low, while January averages a 51°F high and a 31°F low.' },
      { question: 'What is Raleigh weather like year round?', answer: 'Winter is mild, with January highs in the low 50s°F and lows near freezing. Spring and fall are long and comfortable — April and October both average highs in the low-to-mid 70s°F. June through September average highs of 82-89°F with high humidity and frequent afternoon thunderstorms.' },
      { question: 'How cold does Raleigh get in winter?', answer: 'January is the coldest month, averaging a 51°F high and a 31°F low. Freezing nights are common from December through February, but average daytime highs stay above 50°F all winter and extended cold snaps are unusual.' },
  ...
  'cincinnati-oh': {
    ...
    uniqueFacts: [
      ...
      'At 86°F, Cincinnati\'s average July high runs about a degree above Columbus and four above Cleveland.',
    ],
    faqs: [
      { question: 'What is the climate in Cincinnati, Ohio?', answer: 'Cincinnati has a humid continental climate (Köppen Dfa) in the Ohio River valley: warm humid summers, cold winters, and about 42 inches of precipitation a year including roughly 22 inches of snow. July averages an 86°F high, January a 39°F high and a 22°F low.' },
      { question: 'What is Cincinnati weather like year round?', answer: 'January is the coldest month at a 39°F high and a 22°F low. Spring is wet and variable, warming from the low 50s°F in March to the mid-70s°F in May. June through August average highs of 82-86°F with high humidity, and September and October bring the year\'s most settled weather.' },
      { question: 'How much snow does Cincinnati get?', answer: 'About 22 inches in an average winter, noticeably less than northern Ohio. Winter precipitation is often a mix — the river valley sits close to the rain/snow line, so freezing rain and sleet are as common as pure snow.' },
  ...
  'anchorage-ak': {
    ...
    uniqueFacts: [
      ...
      'Average highs stay below freezing from November through February and peak at just 66°F in July.',
    ],
    faqs: [
      { question: 'What is the climate in Anchorage, Alaska?', answer: 'Anchorage has a subarctic climate (Köppen Dfc): long cold winters, short cool summers, and about 75 inches of snow a year. January averages a 22°F high and a 10°F low, while July — the warmest month — averages a 66°F high and a 52°F low.' },
      { question: 'What is Anchorage weather like year round?', answer: 'Average highs stay below freezing from November through February and bottom out at 22°F in January. Spring arrives late, with April still cool at 44°F. June through August are mild, topping out at 66°F in July, and daylight swings from under 6 hours at the winter solstice to more than 19 hours in late June.' },
      { question: 'What is Anchorage weather like by month?', answer: 'Average highs run 22°F in January, 33°F in March, 56°F in May, 66°F in July, 40°F in October and 23°F in December. Lows range from about 10°F in midwinter to 52°F in July, so even the warmest nights stay cool.' },
  ...
  'san-jose-ca': {
    ...
    uniqueFacts: [
      ...
      'San Jose\'s overnight lows never average above 57°F, so even the hottest summer days end with comfortable evenings.',
    ],
    faqs: [
      { question: 'What is the climate in San Jose, California?', answer: 'San Jose has a Mediterranean climate (Köppen Csa/Csb): warm dry summers, mild wet winters, and about 15 inches of rain a year that falls almost entirely between November and April. July and August average highs of 83°F, while December averages a 57°F high and a 42°F low.' },
      { question: 'What is San Jose weather like year round?', answer: 'Winter is mild and wet, with December and January highs in the upper 50s°F and lows in the low 40s°F. Highs climb steadily through spring to 83°F in July and August, then ease back through a warm, dry fall. Summer nights stay cool, with lows averaging 57°F even in the warmest months.' },
      { question: 'What is San Jose weather like by month?', answer: 'Average highs run 58°F in January, 66°F in March, 75°F in May, 83°F in July and August, 74°F in October and 57°F in December. Lows move in a narrower band, from about 42°F in midwinter to 57°F in midsummer.' },
  ...
  'jacksonville-fl': {
    ...
    uniqueFacts: [
      ...
      'At 44°F, Jacksonville\'s average January low is the coldest of Florida\'s largest cities — six degrees below Orlando and eight below Tampa.',
    ],
    faqs: [
      { question: 'What is the climate in Jacksonville, Florida?', answer: 'Jacksonville has a humid subtropical climate (Köppen Cfa): hot, humid, stormy summers and mild, drier winters. July averages a 92°F high and a 74°F low, January averages a 65°F high and a 44°F low, and the city receives about 52 inches of rain a year.' },
      { question: 'What is Jacksonville weather like year round?', answer: 'Winter is mild and comparatively dry, with January highs in the mid-60s°F and lows in the mid-40s°F. Spring warms through the 70s and 80s°F with low humidity. June through September average highs of 87-92°F with daily afternoon thunderstorms, and October and November cool back through the low 80s and 70s°F.' },
      { question: 'Does it rain a lot in Jacksonville?', answer: 'Yes — about 52 inches a year, and it is strongly seasonal. More than half falls between June and September in afternoon thunderstorms driven by the sea breeze. Tropical systems can add several inches in a single event.' },
  ...
  'chandler-az': {
    climateType: 'Hot desert (Köppen BWh)',
    seasons: {
      spring: 'Spring starts ideal — March averages a 78°F high under clear skies, and the Sonoran Desert wildflower bloom peaks. By late April highs are already climbing past 85°F and the dry season is well underway.',
      summer: 'Summers are extreme. Average highs stay at or above 100°F from June through September and peak at 106°F in July, with overnight lows in the low 80s°F. The North American Monsoon brings evening thunderstorms, downpours and dust storms from July onward.',
      fall: 'Fall cools slowly. September still averages 100°F, but October drops to 88°F and November to 75°F. By late fall the evenings turn crisp and the East Valley\'s outdoor season begins in earnest.',
      winter: 'Winters are mild, dry and sunny, with December and January highs in the mid-to-upper 60s°F and lows near 42°F. Rain is infrequent and frost is limited to a few clear mornings in the outlying valley.',
    },
    monthlyHighs: [67, 71, 78, 86, 95, 104, 106, 104, 100, 88, 75, 66],
    monthlyLows: [42, 45, 50, 57, 65, 74, 81, 80, 74, 61, 49, 42],
    bestTimeToVisit: 'November through April. Warm, sunny days in the 60s-80s°F, cool nights, minimal rain, and none of the summer heat. February and March are the busiest months for Cactus League spring training and desert hiking.',
    severeRisks: ['Extreme heat', 'Monsoon thunderstorms', 'Dust storms (haboobs)', 'Flash flooding', 'Wildfires'],
    uniqueFacts: [
      'Chandler sits in the Sonoran Desert at roughly 1,200 feet in the southeast corner of the Phoenix metro, so its daytime highs track central Phoenix almost exactly.',
      'Average highs stay at or above 100°F for four straight months, June through September.',
      'The less-developed East Valley cools off more at night than downtown Phoenix, where pavement and buildings hold the day\'s heat well past midnight.',
      'Annual rainfall is only about 8 inches, and roughly half of it arrives in a handful of monsoon thunderstorms between July and September.',
      'Haboobs — dust walls thousands of feet tall — can cross the East Valley ahead of monsoon storms and cut visibility to near zero within minutes.',
    ],
    faqs: [
      { question: 'What is the climate in Chandler, Arizona?', answer: 'Chandler has a hot desert climate (Köppen BWh): extreme summer heat, mild sunny winters, very low humidity, and only about 8 inches of rain a year. July averages a 106°F high and an 81°F low, while January averages a 67°F high and a 42°F low.' },
      { question: 'What is Chandler weather like year round?', answer: 'Average highs climb past 100°F by June and stay there through September, peaking at 106°F in July. October through April is the mild half of the year, with January averaging a 67°F high and a low near 42°F. Rain is scarce in every single month.' },
      { question: 'How hot does Chandler get in summer?', answer: 'July averages a high of 106°F, and stretches above 110°F happen in most summers. Overnight lows average in the low 80s°F in July and August, so the heat barely relents after dark and outdoor activity is genuinely dangerous in the afternoon.' },
      { question: 'How cold does Chandler get in winter?', answer: 'December and January are the coolest months, averaging highs of 66-67°F and lows near 42°F. Frost occurs on a few clear mornings in the outlying East Valley most winters, but hard freezes are rare and brief.' },
      { question: 'What is monsoon season in Chandler?', answer: 'The North American Monsoon runs from mid-June through September. It brings sudden late-afternoon and evening thunderstorms, heavy downpours, lightning, flash flooding in normally dry washes, and the dust storms known as haboobs.' },
      { question: 'Does it rain a lot in Chandler?', answer: 'No. Annual rainfall is only about 8 inches, split between gentle Pacific storms in winter and intense monsoon thunderstorms in July, August and September. Long stretches pass with no measurable rain at all.' },
      { question: 'Is Chandler weather different from Phoenix?', answer: 'Only slightly. Chandler sits about 20 miles southeast of downtown Phoenix at a similar elevation, so daytime highs are nearly identical. The difference shows up overnight: the less-developed East Valley cools off a few degrees more than the urban core.' },
      { question: 'When is the best time to visit Chandler?', answer: 'November through April. Warm sunny days, cool nights, almost no rain, and none of the summer heat. February and March are peak season for spring training baseball across the Valley and for hiking the surrounding desert preserves.' },
    ],
  },
}
...
export const cityNeighbors: Record<string, string[]> = {
  ...
  'washington-dc': ['baltimore-md', 'philadelphia-pa', 'virginia-beach-va', 'raleigh-nc'],
  'buffalo-ny': ['cleveland-oh', 'pittsburgh-pa', 'detroit-mi', 'new-york-ny'],
  'chandler-az': ['phoenix-az', 'tucson-az', 'las-vegas-nv', 'albuquerque-nm'],
}
