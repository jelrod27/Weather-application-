...
key_phrases:
  - nocturnal convective system with a functioning low-level jet
  - forward-propagating supercell or organized squall line tracking the mid-Atlantic slope
  - convective axis ran along and east of the central Plains
  - positionally stable subtropical ridge that is not expected to break down meaningfully
  - probability is too high and too date-specific for scattered afternoon storms
  - post-frontal airmass will be cool and modified rather than humid and unstable
  - secondary disturbance riding the southern branch of the jet
  - sits on the drier western fringe of whatever moisture axis feeds the Southeast event
  - five warnings across three states in under an hour
  - back-to-back warnings from the Springfield office
similarity_max: 0.82
...
images_used:
  ...
  - goes16-water-vapor
image_audit:
  - "id=mesocyclone-diagram; lane=severe; anchor=The week's headline number is 205; tags=severe_storms; caption=Schematic of mesocyclone structure within a supercell."
  - "id=fault-types-usgs; lane=earthquake; anchor=On the geophysical side, a M7.8; tags=earthquakes; caption=USGS diagram of normal, reverse, and strike-slip fault motion."
  - "id=goes16-water-vapor; lane=forecast; anchor=The dominant synoptic feature shaping the; tags=atmosphere_layers,tropical,tech_and_models; caption=GOES-16 mid-level water vapor — visualizes upper-tropospheric moisture and jet stream flow."
