...
opener_hash: e3930eea
key_phrases:
  - wind-heavy ratio that points to organized linear convection
  - transitioning to squall-line mode as the boundary accelerated east
  - two geographic pulses
  - rarely anchors a tornado sequence of this duration
  - sustained northeast-tracking corridor over roughly 20 hours
  - low-level jet is forecast to pulse on multiple nights
  - isolated severe weather is possible on four or five of the next seven days rather than being confined to a single outbreak day
  - how cleanly the cap breaks
  - MCS that organize overnight on the Plains often arrive in the Ohio Valley in weakened but still wind-capable form
  - "Tuesday's convection deposits 2+ inches before the Thursday system arrives on already-saturated soil"
similarity_max: 0.72
...
![Latest GOES-16 GeoColor view of the contiguous US.](https://cdn.star.nesdis.noaa.gov/GOES16/ABI/CONUS/GEOCOLOR/1250x750.jpg)
*NOAA NESDIS*
...
![Classic supercell thunderstorm over Chaparral, New Mexico.](https://commons.wikimedia.org/wiki/Special:FilePath/Chaparral_Supercell_2.JPG?width=1280)
*Greg Lundeen / NOAA*
...
A pattern shift is underway across the North Atlantic. A weakening ridge over the British Isles is allowing a series of Atlantic lows to push onshore through Scandinavia and the Iberian Peninsula. Northern Spain and southern France are forecast to see 40–70 mm of rainfall over a 72-hour period mid-week, with the Pyrenees potentially exceeding 100 mm — a meaningful total for early June climatology in that region. Travel disruptions along the Bay of Biscay coast are plausible by Wednesday.
