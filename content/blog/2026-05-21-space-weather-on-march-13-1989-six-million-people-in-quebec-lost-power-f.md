...
tags:
  ...
  - weather
  - science
heroImage: https://sdo.gsfc.nasa.gov/assets/img/latest/latest_1024_0171.jpg
readTime: 4
cadence: wednesday_topic
opener_hash: 7dea2140
key_phrases:
  - G5 geomagnetic storm collapsed the grid in under two minutes
  - billion-ton cloud of magnetized plasma launched toward Earth
  - field orientation cannot be confirmed until the cloud reaches the L1 Lagrange point
  - 15 to 60 minutes before impact to act on a grid protection decision
  - northward-pointing CME can pass largely without consequence regardless of its size
  - "aurora oval expands to roughly 55° geomagnetic latitude"
  - Solar Cycle 25 tracking above the consensus forecast issued at cycle start
  - days-long elevated particle environment that follows a major CME
  - flare itself is only the opening act
  - auroras reported in Texas and Cuba during the most intense storms of the 20th century
similarity_max: 0
...
theme: "On March 13, 1989, six million people in Quebec lost power for nine hours."
---
...
![Current Sun in 171 Å — quiet corona, ~600,000 K plasma.](https://sdo.gsfc.nasa.gov/assets/img/latest/latest_1024_0171.jpg)
*NASA SDO*
