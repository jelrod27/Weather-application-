...
opener_hash: 03de596a
key_phrases:
  - "12-degree gap between the airport's open tarmac and the city's interior"
  - urban canyons where the effective sky-view factor drops sharply
  - the canyon traps heat the way a thermos traps coffee
  - physiological debt accumulates across consecutive days
  - pollution dome visible in satellite imagery as a persistent haze
  - recirculating cell that concentrates emissions rather than dispersing them
  - rainfall enhancement zone 30 to 60 kilometers downwind of the urban core
  - the city exports some of its meteorological signature to the surrounding region
  - evapotranspiration pathway that development closed
  - a mature street tree can transpire 100 gallons of water on a hot day
similarity_max: 0
...
theme: "On the night of July 21, 1995, Chicago's official low temperature at O'Hare International Airport dropped to 73°F."
---
