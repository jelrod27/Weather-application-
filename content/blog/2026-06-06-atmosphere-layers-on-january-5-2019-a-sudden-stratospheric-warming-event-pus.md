...
tags:
  ...
  - aviation
  - urban-climate
heroImage: "https://commons.wikimedia.org/wiki/Special:FilePath/Atmosphere_layers-en.svg?width=1280"
readTime: 5
cadence: wednesday_topic
opener_hash: 8e12df2e
key_phrases:
  - "sudden stratospheric warming event pushed temperatures at 10 hPa up by more than 30°C in under a week"
  - six weeks later
  - "the plumbing has been there all along; most people just never learned to read it"
  - slow-moving reservoir that can store anomalies for weeks before leaking them downward
  - cold enough to freeze the trace amounts of water vapor that make it up there
  - temperatures that would read as thousands of degrees on a thermometer but would transfer almost no heat to a physical object
  - a block sitting over Greenland in January is not an accident
  - "polar vortex wind speed at 60°N"
  - SSWs occur roughly six times per decade
  - extend useful probabilistic guidance about surface weather patterns to ranges well beyond the standard 10-day window
similarity_max: 0.22
...
topic_title: Atmospheric Structure
theme: "On January 5, 2019, a sudden stratospheric warming event pushed temperatures at 10 hPa — roughly 30 km above sea level —"
---
