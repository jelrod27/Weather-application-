...
opener_hash: 5d9a9e31
key_phrases:
  - 302 mph ceiling marker for what the atmosphere can do
  - loads the gun
  - CAPE as the fuel reserve
  - horizontal spin tilted into the vertical
  - dryline as a trigger for convective initiation
  - most active zone shifting eastward into Dixie Alley
  - "bow echo shaped like an archer's bow"
  - self-reinforcing rear-inflow jet
  - rotating wall cloud as a prompt to seek shelter not a photo opportunity
  - two tornadoes with identical wind speeds can receive different ratings depending on what they hit
similarity_max: 0.35
...
theme: "On May 3, 1999, a supercell thunderstorm near Bridge Creek, Oklahoma produced a tornado with the highest wind speed ever"
---
...
![F5 tornado near Elie, Manitoba (2007) — only F5 ever recorded in Canada.](https://commons.wikimedia.org/wiki/Special:FilePath/F5_tornado_Elie_Manitoba_2007.jpg?width=1280)
...
![Supercell wall cloud illuminated by lightning.](https://commons.wikimedia.org/wiki/Special:FilePath/Wall_cloud_with_lightning_-_NOAA.jpg?width=1280)
*NOAA*
