...
tags:
  ...
  - tech-and-models
  - historical-events
heroImage: "https://commons.wikimedia.org/wiki/Special:FilePath/USGS_sumatra_mts.gif?width=1280"
readTime: 5
cadence: wednesday_topic
opener_hash: f2114fe0
key_phrases:
  - PAGER RED alert threshold where international humanitarian attention is warranted before field teams set foot on the ground
  - "shallow strike-slip rupture arrives fast, sharp, and repetitive"
  - "engineered buildings begin to fail, not just crack"
  - country-specific fragility models that estimate how well local building stock survives various shaking levels
  - PAGER revision history as informative about the accuracy of regional fragility data
  - "Omori's Law decay as the inverse of time since the main shock"
  - structures already compromised by the main rupture disproportionately vulnerable to secondary events
  - "probabilistic triage tool, not a casualty count"
  - high-frequency ground motion particularly destructive to mid-rise unreinforced masonry
  - hypocenter at 10 km shakes a much larger area at damaging intensities than the same magnitude at 50 or 70 km depth
similarity_max: 0.12
similarity_judge: claude-sonnet-4-6
model_used: claude-sonnet-4-6
images_used:
  - sumatra-moment-tensor-2004
  - global-quake-epicenters-1963-98
  - alaska-earthquake-1964-fourth-ave
image_audit:
  - "id=sumatra-moment-tensor-2004; lane=earthquakes; anchor=as more seismic stations report in.; tags=earthquakes,tech_and_models; caption=USGS moment tensor (beachball) solution for the magnitude 9.1 2004 Sumatra-Andaman earthquake."
  - "id=global-quake-epicenters-1963-98; lane=earthquakes; anchor=the dominant construction type across much of rural and small-city Venezuela.; tags=earthquakes,tech_and_models; caption=Global map of earthquake epicenters from 1963 to 1998, tracing the world's tectonic plate boundaries."
  - "id=alaska-earthquake-1964-fourth-ave; lane=earthquakes; anchor=not just crack.; tags=earthquakes,historical_events; caption=Graben subsidence collapsing Fourth Avenue in downtown Anchorage during the 1964 Great Alaska earthquake."
spotlight_active: null
generation_retries: 0
word_count: 838
closer_used: on-the-radar
topic_slug: earthquakes
topic_title: "Earthquakes & Seismic Hazards"
theme: "A magnitude 7.2 earthquake struck 23 kilometers southeast of Yumare, Venezuela — a small agricultural town in Yaracuy st"
---
...
![Graben subsidence collapsing Fourth Avenue in downtown Anchorage during the 1964 Great Alaska earthquake.](https://commons.wikimedia.org/wiki/Special:FilePath/AlaskaQuake-FourthAve.jpg?width=1280)
*U.S. Army / USGS*
...
![Global map of earthquake epicenters from 1963 to 1998, tracing the world's tectonic plate boundaries.](https://commons.wikimedia.org/wiki/Special:FilePath/Quake_epicenters_1963-98.png?width=1280)
...
![USGS moment tensor (beachball) solution for the magnitude 9.1 2004 Sumatra-Andaman earthquake.](https://commons.wikimedia.org/wiki/Special:FilePath/USGS_sumatra_mts.gif?width=1280)
