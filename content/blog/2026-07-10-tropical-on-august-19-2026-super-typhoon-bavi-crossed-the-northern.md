...
title: "Tropical Systems: On August 19, 2026, Super Typhoon Bavi crossed the Northern Mariana Islands with sustained w"
...
key_phrases:
  - polar vortex hangover
  - MJO locked in anomalously persistent active phase
  - "depth of the 26°C isotherm"
  - warm layer extends to 100 meters or deeper
  - northeast eyewall directly over Tinian and the southern tip of Saipan
  - surge can stack faster and higher than the same wind speed would produce against a steeply sloping seafloor
  - three Category 5-equivalent storms before the Atlantic season had produced anything close to a comparable threat
  - rapid intensification events compress the warning timeline
  - MJO stalls and the favorable window extends well beyond what seasonal forecasters predicted
  - shallow reef shelves that can amplify storm surge
similarity_max: 0.15
...
topic_slug: tropical
topic_title: Tropical Systems
theme: "On August 19, 2026, Super Typhoon Bavi crossed the Northern Mariana Islands with sustained winds estimated at 180 mph — "
---
...
![NOAA Climate Prediction Center sea surface temperature anomaly map.](https://www.cpc.ncep.noaa.gov/products/analysis_monitoring/enso_advisory/figure01.gif)
*NOAA CPC*
