...
opener_hash: 81a96b0f
key_phrases:
  - thunderstorm asthma mechanism
  - fractured rye grass pollen grains into particles small enough to penetrate deep into the bronchial tree
  - phenological decoupling
  - gust front from a mature convective cell moving through a high-pollen environment during peak allergy season
  - photon budget reaching those retinal cells falls below the threshold needed to suppress daytime melatonin production
  - solar elevation angle drops below 10 degrees for weeks at a time
  - 74 consecutive days above WBGT threshold
  - pollen calendars show the same logic
  - two biological clocks that once synchronized now run at different rates because they respond to different atmospheric variables
similarity_max: 0
...
![Rye grass pollen grain under electron microscopy, showing fractured outer wall](placeholder)
...
![Wet-bulb globe temperature monitoring station at an outdoor worksite](placeholder)
