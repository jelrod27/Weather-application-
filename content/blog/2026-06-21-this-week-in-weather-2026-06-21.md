...
opener_hash: 4fd33ab4
key_phrases:
  - wind-dominant ratio
  - tight geographic cluster driven by discrete supercell activity along the dryline
  - two distinct convective regimes operating during the period
  - heat consolidation phase rather than a severe weather phase
  - shortwave energy rotating around the base of the ridge
  - low-level jet pulsing moisture northward on successive nights
  - two-speed country
  - heat-locked southern tier
  - orographic afternoon convection over the Front Range
  - "M6.0+ count to four within roughly 96 hours"
similarity_max: 0.82
...
image_audit:
  - "id=mesocyclone-diagram; lane=severe; anchor=The week's sharpest convective signal came; tags=severe_storms; caption=Schematic of mesocyclone structure within a supercell."
  - "id=earthquake-wave-paths; lane=forecast; anchor=Roadmap; tags=earthquakes,atmosphere_layers; caption=Seismic wave paths through Earth after an earthquake."
  - "id=pacific-ring-of-fire; lane=earthquake; anchor=The week's largest seismic event was; tags=earthquakes,volcanoes; caption=Pacific Ring of Fire — major volcanic and earthquake belt around the Pacific basin."
...
![Seismic wave paths through Earth after an earthquake.](https://commons.wikimedia.org/wiki/Special:FilePath/Earthquake_wave_paths.svg?width=1280)
