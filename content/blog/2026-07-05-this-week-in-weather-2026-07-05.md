...
opener_hash: 702a051f
key_phrases:
  - fast-moving linear convection rather than discrete supercells
  - ridge reasserts and desiccates the pattern
  - stubborn upper-level ridge anchored over the southern tier
  - "the risk is duration, not a single extreme event"
  - monsoon-adjacent pattern
  - disturbance train that moves through the Northeast
  - the July 7 spike is sharp enough to suggest a defined lifting mechanism
  - "overnight lows that won't drop far enough for meaningful recovery represent cumulative physiological stress"
  - "built for a climate that historically required heating, not cooling"
  - the active region that generated it may still be geoeffective
similarity_max: 0
...
image_audit:
  - "id=swpc-space-weather-overview; lane=severe; anchor=no significant geomagnetic impact followed.; tags=space_weather,tech_and_models; caption=NOAA SWPC space-weather overview — real-time Kp, X-ray flux, and proton flux."
  - "id=wpc-surface-analysis-fronts; lane=forecast; anchor=keeping the Northeast and parts of the Midwest in an active pattern.; tags=atmosphere_layers,tech_and_models; caption=Latest NWS/WPC US surface analysis showing fronts, pressure centers, and isobars."
  - "id=goes19-fulldisk-airmass-rgb; lane=forecast; anchor=89°F for the week is the callout here.; tags=atmosphere_layers,tech_and_models; caption=GOES-19 (GOES-East) full-disk Air Mass RGB distinguishing warm, cold, dry, and stratospheric air and jet-stream structure."
...
![Latest NWS/WPC US surface analysis showing fronts, pressure centers, and isobars.](https://www.wpc.ncep.noaa.gov/noaa/noaad1.gif)
