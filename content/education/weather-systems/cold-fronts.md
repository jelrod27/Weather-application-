...
entrySlug: cold-fronts
title: Cold Fronts
summary: Understand why a cold front's steep slope produces its narrow storm band, wind veer, pressure kick and temperature drop — and how it finally occludes and kills the cyclone.
...
sources:
  ...
  - label: NWS Glossary — Advection
    url: https://forecast.weather.gov/glossary.php?word=advection
fact_check_flagged:
  - A front's map line is where a sloping frontal surface, tilted back over hundreds of kilometres of cold air, intersects the ground.
  - Frontal lifting alone accounts for all cold-front precipitation, requiring no daytime heating, terrain, or sea breeze.
  - Ahead of a cold front the surface wind advects warm air northward and behind it the wind veers to bring cold air in, with the shift occurring over minutes.
  - Fronts extend outward from the centre of a low-pressure system.
  - Surface pressure is lowest along the front and rises after the colder, denser air arrives behind it.
  - After the convective band passes, skies clear because the cold air mass interior is dry and stable.
