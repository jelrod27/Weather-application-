...
entrySlug: warm-fronts
title: Warm Fronts
summary: Understand why a warm front's gentle slope produces cirrus-to-nimbostratus in a fixed order, how the halo and shadow tests date its arrival, and why fog and occlusion follow.
...
fact_check_flagged:
  - A warm front's leading clouds begin as ice filaments thousands of feet up.
  - Warm fronts are drawn on surface maps as a line with red semicircles.
  - The cold front trails to the southwest and the warm front extends east.
  - The warm front travels northeast ahead of the low's centre, with the warm sector following behind it.
