...
sources:
  ...
  - label: NWS Glossary — Trough
    url: https://forecast.weather.gov/glossary.php?word=trough
  - label: NWS Glossary — Occluded Front
    url: https://forecast.weather.gov/glossary.php?word=occluded%20front
  - label: NOAA JetStream — Air Pressure
    url: https://www.noaa.gov/jetstream/atmosphere/air-pressure
  - label: NOAA JetStream — The Origin of Wind
    url: https://www.noaa.gov/jetstream/synoptic/origin-of-wind
  - label: NOAA JetStream — The Norwegian Cyclone Model
    url: https://www.noaa.gov/jetstream/synoptic/norwegian-cyclone-model
  - label: NOAA JetStream — Basic Wave Patterns
    url: https://www.noaa.gov/jetstream/upper-air-charts/basic-wave-patterns
  - label: NOAA JetStream — 500 mb Constant Pressure Charts
    url: https://www.noaa.gov/jetstream/upper-air-charts/constant-pressure-charts-500-mb
  - label: NOAA JetStream — Synoptic Meteorology
    url: https://www.noaa.gov/jetstream/synoptic
fact_check_flagged:
  - The term "depression" is a third name for the same object, derived from the barometer trace pressing down.
  - No numerical pressure threshold defines a depression.
  - These cyclones follow specific storm tracks across the North Atlantic, North Pacific and Southern Ocean.
