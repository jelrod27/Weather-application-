...
sources:
  - label: NWS Glossary — Anticyclone
    url: https://forecast.weather.gov/glossary.php?word=anticyclone
  ...
  - label: NWS Glossary — Inversion
    url: https://forecast.weather.gov/glossary.php?word=inversion
...
fact_check_flagged:
  - A high's sinking motion occurs over an area hundreds of miles across.
  - Warming air lowers its relative humidity.
  - Fair-weather cumulus tops flatten at a common altitude marking the base of the inversion.
  - Subsidence traps surface emissions and produces a milky, brownish haze layer at the horizon.
  - Clear skies allow efficient radiation of heat to space at night.
  - Under a strong winter anticyclone the inversion may persist all day, trapping fog, haze and cold air in valleys.
---
