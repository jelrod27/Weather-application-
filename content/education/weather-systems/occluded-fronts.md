...
entrySlug: occluded-fronts
title: Occluded Fronts
summary: Learn why an occluded front lifts warm air off the ground entirely, how cold and warm occlusions differ, what mixed precipitation to expect, and why occlusion signals a cyclone's decline.
...
sources:
  ...
  - label: NWS Glossary — Extratropical Cyclone
    url: https://forecast.weather.gov/glossary.php?word=extratropical%20cyclone
...
fact_check_flagged:
  - An occluded front is the only front type at which warm air is not present at the surface, having been lifted clear of the ground.
  - The word occluded derives from Latin occludere, meaning to shut up or close off.
  - Classifying an occlusion type is difficult from a single location and requires knowing temperatures on both sides and air mass histories.
  - An occlusion combines the broad stratiform precipitation of the warm front with the convective band of the cold front, overlapping.
  - In an occluded system the warm air sits several thousand feet above the surface and never reaches the ground.
