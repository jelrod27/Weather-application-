...
sources:
  ...
  - label: NWS Glossary — Cirrus
    url: https://forecast.weather.gov/glossary.php?word=cirrus
  ...
  - label: NWS Glossary — Virga
    url: https://forecast.weather.gov/glossary.php?word=virga
...
fact_check_flagged:
  - Nimbostratus has no rolls, tessellation, rounded elements or fibrous striations.
  - A warm air mass overrides cooler denser air along a shallow sloping boundary extending hundreds of miles ahead of the surface front.
  - The cirrostratus-to-altostratus-to-nimbostratus progression typically unfolds over several hours as a warm front approaches.
  - Nimbostratus precipitation comes from a single continuous sheet lifted along a frontal slope and lasts as long as the front takes to pass.
  - On weather radar, convective storms appear as discrete isolated returns with hard edges and gaps between them.
  - On radar, frontal nimbostratus appears as a large smooth uniform field of echo with no cellular structure.
  - A nimbostratus deck takes six to twelve hours to build and spans a frontal slope hundreds of miles across.
diagrams:
  - id: cloud-altitude-plot
    insertAfter: rain falling out of the bottom of it
---
