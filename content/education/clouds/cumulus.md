...
fact_check_flagged:
  - The Latin word cumulus means 'heap'.
  - The condensation surface must be at least a micrometre across (source specifies a radius of at least one micrometer).
  - Individual cumulus cells are short-lived.
  - Flattening, spreading cumulus tops indicate stable air aloft that the cloud cannot penetrate.
  - Virga is defined as streaks of rain that evaporate before reaching the ground.
diagrams:
  - id: cloud-altitude-plot
    insertAfter: extends well into the high-cloud range
---
