...
word_count: 1097
fact_check_claims: 32
fact_check_unsupported: 10
sources:
  - label: NWS Glossary — Altocumulus
    url: https://forecast.weather.gov/glossary.php?word=altocumulus
...
fact_check_flagged:
  - Mie scattering is named for the particle size involved.
  - Cirrocumulus clouds are always composed of ice.
  - Altocumulus forms by convection confined to a mid-level layer, with rising and sinking air organizing into rolls or cells.
  - The spacing between altocumulus elements reflects the size of convective cells, which reflects the depth of the unstable layer.
  - Air lifted over mountains cools adiabatically and the downwind wave pattern produces regular cloud bars.
  - Apparent element size works as a discriminator because it is a proxy for distance/cloud height.
  - The corona is produced by diffraction around water droplets.
  - Halos are caused by ice crystals refracting light.
  - Morning altocumulus indicates the middle atmosphere is already overturning without surface heating, signalling instability relevant to afternoon storms.
  - Altocumulus elements growing into turrets during the morning indicate active convection in the mid-level layer.
diagrams:
  - id: cloud-altitude-plot
    insertAfter: Same heap, higher shelf.
---
