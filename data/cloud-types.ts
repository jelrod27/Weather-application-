...
export const cloudDatabase: CloudData[] = [
  ...
  // UNUSUAL SPECIES AND SUPPLEMENTARY FEATURES
  {
    id: 11,
    name: "MAMMATUS",
    abbreviation: "Ma",
    category: "rare",
    cloudType: "feature",
    parentGenus: "Cirrus / Cirrocumulus / Altocumulus / Altostratus / Stratocumulus / Cumulonimbus",
    ...
    weatherPrediction: "May accompany storms, but does not establish storm severity",
    description16bit: "Inverted pixel pouches defying gravity",
    formation: "Pouches beneath a cloud layer; formation processes depend on the cloud environment",
    density: "0.3-1.5 g/m3",
    funFact: "WMO calls this supplementary feature mamma; it occurs beneath several cloud genera, not only thunderstorm anvils.",
  ...
  },
  {
    ...
    category: "rare",
    cloudType: "species",
    parentGenus: "Altocumulus / Cirrocumulus / Stratocumulus",
    altitudeRange: "6,500-40,000 ft",
    temperature: "Variable",
    dropletSize: "5-50 um",
    formationTime: "1-3 hours",
    windSpeed: "40-100+ mph",
    pressureRange: "Depends on cloud altitude",
    weatherPrediction: "Turbulent winds near mountains",
    description16bit: "Flying saucer sprites over mountain ranges",
    formation: "Moist air rises in atmospheric waves, often near mountains but also without pronounced terrain",
    density: "0.2-0.8 g/m3",
  ...
  },
  {
    ...
    category: "rare",
    cloudType: "feature",
    parentGenus: "Altocumulus / Stratocumulus",
    ...
    pressureRange: "Variable",
    weatherPrediction: "The wave pattern alone does not determine the weather hazard",
    description16bit: "Chaotic wave patterns in the sky matrix",
    formation: "Irregular waves on the cloud underside; the feature describes appearance rather than a single formation mechanism",
    density: "0.3-1.2 g/m3",
    funFact: "Asperitas is a supplementary feature with chaotic waves, unlike the more orderly pattern of undulatus.",
